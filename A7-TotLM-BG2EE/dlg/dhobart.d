...
IF ~~ THEN BEGIN 11
  SAY @26951
  IF ~AreaCheck("BD3000")~ THEN DO ~SetGlobal("ID#Master_Quest","GLOBAL",1) SetGlobal("ID#Master_Quest_Location","GLOBAL",2) ClearAllActions() StartCutSceneMode() StartCutSceneEx("cyHobTl1",TRUE)~ EXIT
  IF ~AreaCheck("AR5501")~ THEN DO ~SetGlobal("ID#Master_Quest","GLOBAL",1) SetGlobal("ID#Master_Quest_Location","GLOBAL",3) ClearAllActions() StartCutSceneMode() StartCutSceneEx("cyHobTl1",TRUE)~ EXIT
  IF ~!AreaCheck("BD3000") !AreaCheck("AR5501")~ THEN DO ~SetGlobal("ID#Master_Quest","GLOBAL",1) SetGlobal("ID#Master_Quest_Location","GLOBAL",1) ClearAllActions() StartCutSceneMode() StartCutSceneEx("cyHobTl1",TRUE)~ EXIT
END

...
IF ~~ THEN BEGIN 6
  SAY @26946
  IF ~~ THEN REPLY @26978 DO ~SetGlobal("ID#Hobart_Told","GLOBAL",1)
~ GOTO 7
  IF ~~ THEN REPLY @26979 DO ~SetGlobal("ID#Hobart_Told","GLOBAL",1)
~ GOTO 8
  IF ~~ THEN REPLY @26980 DO ~SetGlobal("ID#Hobart_Told","GLOBAL",1)
~ GOTO 9
  IF ~~ THEN REPLY @26969 DO ~SetGlobal("ID#Hobart_Told","GLOBAL",1)
~ GOTO 10
END
...
IF ~~ THEN BEGIN 11
  SAY @26951
  IF ~~ THEN DO ~SetGlobal("ID#Master_Quest","GLOBAL",1)
ClearAllActions()
StartCutSceneMode()
...
~ THEN BEGIN 12
  SAY @26952
  IF ~  !Global("ID#Hobart_Told","GLOBAL",1)
~ THEN REPLY @26992 GOTO 6
  IF ~  Global("ID#Hobart_Told","GLOBAL",1)
~ THEN REPLY @26993 GOTO 11
  IF ~~ THEN REPLY @26994 EXIT
END

IF WEIGHT #1 ~  Global("ID#Master_Quest","GLOBAL",1)
~ THEN BEGIN 13
  SAY @26953
...
IF ~~ THEN BEGIN 16
  SAY @26956
  IF ~~ THEN DO ~SetGlobal("ID#Master_Quest","GLOBAL",2)
ClearAllActions()
StartCutSceneMode()
...
IF WEIGHT #2 ~  Global("ID#Master_Quest","GLOBAL",2)
~ THEN BEGIN 19
  SAY @27134
  IF ~  Global("ID#Know_Luremaster","GLOBAL",1)
~ THEN REPLY @27157 DO ~SetGlobal("ID#Know_Luremaster","GLOBAL",2)
~ GOTO 20
  IF ~  Global("ID#Know_Hobart_Store","GLOBAL",1)
~ THEN REPLY @27159 DO ~StartStore("Hobart",LastTalkedToBy)
~ EXIT
  IF ~  Global("ID#Know_Hobart_Store","GLOBAL",0)
~ THEN REPLY @3153 DO ~SetGlobal("ID#Know_Hobart_Store","GLOBAL",1)
~ GOTO 23
  IF ~  Global("ID#Know_Hobart_Store","GLOBAL",0)
~ THEN REPLY @27161 DO ~SetGlobal("ID#Know_Hobart_Store","GLOBAL",1)
~ GOTO 24
...
IF ~~ THEN BEGIN 22
  SAY @27137
  IF ~~ THEN REPLY @3153 DO ~SetGlobal("ID#Know_Hobart_Store","GLOBAL",1)
~ GOTO 23
  IF ~~ THEN REPLY @27161 DO ~SetGlobal("ID#Know_Hobart_Store","GLOBAL",1)
~ GOTO 24
  IF ~~ THEN REPLY @27162 EXIT
END
...
IF ~~ THEN BEGIN 25
  SAY @27140
  IF ~~ THEN REPLY @24061 DO ~StartStore("Hobart",LastTalkedToBy)
~ EXIT
END

IF WEIGHT #3 ~  GlobalGT("ID#Master_Quest","GLOBAL",2)
Global("ID#Hobart_Keep","GLOBAL",0)
~ THEN BEGIN 26
  SAY @27141
  IF ~~ THEN REPLY @27178 DO ~SetGlobal("ID#Hobart_Keep","GLOBAL",1)
~ GOTO 27
END
...
~ THEN REPLY @27183 GOTO 30
  IF ~  Alignment(LastTalkedToBy,MASK_EVIL)
Class(LastTalkedToBy,MAGE)
~ THEN REPLY @27184 GOTO 30
...
IF ~~ THEN BEGIN 37
  SAY @27153
  IF ~~ THEN DO ~AddJournalEntry(@27214,QUEST)
~ GOTO 38
END
...
IF ~~ THEN BEGIN 38
  ...
  IF ~~ THEN REPLY @27216 DO ~StartStore("Hobart",LastTalkedToBy)
~ EXIT
...
IF WEIGHT #4 ~  GlobalGT("ID#Master_Quest","GLOBAL",2)
Global("ID#Hobart_Keep","GLOBAL",1)
~ THEN BEGIN 41
  SAY @27134
  IF ~  Global("ID#Know_Hobart_Store","GLOBAL",1)
~ THEN REPLY @27159 DO ~StartStore("Hobart",LastTalkedToBy)
